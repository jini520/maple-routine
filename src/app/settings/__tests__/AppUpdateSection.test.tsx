...
//    import 하는 것만으로 죽어(`import.meta.env`) 목을 걸 자리조차 없다([[ADR-128]] 결정 7 ·
...
//
// **표시 상태 열넷을 하나도 빼지 않고 훑는다** — 그 표가 [[ADR-026]]·[[ADR-027]]·[[ADR-126]] 이
...
describe('AppUpdateSection', () => {
  ...
  // [[ADR-118]] 결정 2: 이 카드가 놓이는 화면의 제목이 이미 「앱 정보」다.
  ...
  // 지금 이 앱에서 **실제로 도달하는 유일한 상태**다([[ADR-128]] 결정 7) — 그 사실이 이 카드의
  // 모양을 정한다.
