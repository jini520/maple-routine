// 컨텐츠 카드가 공유하는 라벨 표와 상태 판정 ([[ADR-094]] 결정 7 로 화면에서 분리).
//
// 배지 자체는 여기 없다. 그리는 것은 `components/atoms/Badge` 하나이고 ([[ADR-195]] 결정 1),
// 여기 남은 것은 어떤 라벨과 어떤 variant 를 고를지 정하는 도메인 데이터다 ([[ADR-195]] 결정 5).
