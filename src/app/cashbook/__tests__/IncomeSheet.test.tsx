...
describe('판매 수수료', () => {
   ...
   *
   * 종전에는 요율만 손으로 풀고 친 금액은 남았다. 갈래마다 상태를 한 함수가 들고
...
describe('메소 획득량', () => {
  ...
  /**
   * **줄을 하나 줄인다**. 시트가 82vh 를 넘겨 스크롤이 났다. 숫자와 그것을
 ...
 *
 * 이 자리는 한때 카운트업의 기억(모듈 수준이라 시트를 닫아도 남았다) 때문에 지난 기록의
 * 금액에서 굴러왔다. 카운트업 자체를 걷으면서 그 장치가 사라졌지만 회귀를 막으려고 결과는
 * 그대로 붙든다.
 */
