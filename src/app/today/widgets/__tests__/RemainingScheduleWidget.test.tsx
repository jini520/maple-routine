...
// ④ **목록은 캐릭터 전부**. 완료해도 안 빠지고, 순서는 **보고 있는 주기**가 정한다
...
describe('주기 탭', () => {
  ...
  // 라벨은 **어느 탭에서나** 붙는다. 값이 있는 갈래가 자기 이름과 함께 선다.
...
describe('0 은 언제나 CLEAR', () => {
  ...
  // 레벨 미달로 대상이 아닌 보스도 여기서는 0 이다. **가르지 않는다**.
...
describe('목록은 캐릭터 전부다', () => {
  ...
  // 순서는 **보고 있는 주기**가 정한다. 뷰모델은 관리 순서까지만 세워 준다.
