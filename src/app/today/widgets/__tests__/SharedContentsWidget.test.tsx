...
describe('계열이 축이다 ([[ADR-147]] 정정 28)', () => {
...
describe('오른쪽 열은 `count` 유무 하나로 갈린다 ([[ADR-182]] 결정 4)', () => {
  ...
  it('카운트가 있으면 분자와 분모를 붙여 그린다 ([[ADR-147]] 정정 7 과 같은 이유)', async () => {
...
describe('빈 상태와 이동 ([[ADR-147]] 결정 5)', () => {
...
describe('머리의 `?` — 월드 한계를 말한다 ([[ADR-147]] 정정 34)', () => {
