...
describe('떠 있는 바의 색', () => {
  ...
  // 덩어리로 뜬다(실기기 실측 (255,215,239) 대 iOS (246,245,245)).
  //
  ...
  // 다크는 원색이 알약보다 어두워 활성이 비활성보다 흐려진다(레테 실측 L0.62 대 muted L0.73).
  ...
  // (실측 알약−카드 +11.4). 그래서 라이트의 tint 는 얹는 값이 아니라 그 하이라이트를 덜어내는
  // 값이어야 한다.
