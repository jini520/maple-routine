...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    date: '2026-09-17',
    // `items` 에서 파생하지 않았다(사용자가 직접 썼다). 1.0.10+1 발행 때 사용자가 그 패치의 두 줄로 바꿨다
    // (2026-09-17). 패치 노트는 이 노트에 이어 붙이고, 모달은 이 줄을 띄운다.
    highlights: [
      '노말 흉성, 노말 카링 결정석 가격 수정 반영',
      '월드 리프를 완료한 캐릭터의 보스 수익에 시즌보스메이린이 출력 되는 현상 수정',
    ],
