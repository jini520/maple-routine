...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    // 근거는 v1.0.7 마일스톤의 닫힌 이슈 12건과 1.0.6 이후 머지된 PR #237~#277 이고, 그중 화면에서
    // 겪는 변화만 골랐다. 그래서 노트가 PR 수보다 훨씬 짧다. 대부분은 가계부 하나를 세우는
    // 조각들이거나 사용자가 안 겪는 정리다.
    //
  ...
  },
  {
    ...
    // 된다(사용자 결정). 그래서 이 버전에는 `fix` 항목이 하나도 없다.
    items: [
      {
        category: 'feature',
        text: 'today 페이지 추가',
