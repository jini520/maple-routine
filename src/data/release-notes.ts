...
// 릴리스 노트의 진실 원천 한 벌. 개발 노트 화면과 `latest.json` 의 `notes` 가
...
export const RELEASE_NOTES: ReleaseNote[] = [
  ...
  },
  {
    ...
    date: '2026-08-19',
    // 네 줄이다(사용자가 정한 문장, 2026-08-19). 의 "3~4줄" 상한을 채운
  ...
  },
  {
    version: '1.0.5',
    date: '2026-08-12',
    // 긴급 수정 한 건뿐이라 핵심 목록도 한 줄이다(의 "3~4줄"은 상한이지 채워야 할
