...
export const dropItemPriceGuide: FeatureGuide = {
  ...
  sections: [
    {
      id: 'where',
      title: '아이템 가격 입력 화면 열기',
      blocks: [
        // TODO(#198): 보스 수익 화면의 떠 있는 버튼. 아직 스크린샷이 없다
        {
          text: '보스 수익의 주간 탭 오른쪽 아래에 아이템 그림이 도는 동그란 버튼이 있습니다. 누르면 그 주에 기록해 둔 드롭에 실제로 판 금액을 매길 수 있습니다.',
        },
        {
          image: {
            src: screenImage,
        ...
        {
          text: '캐릭터별로 드롭 기록이 모여 있고, 맨 위에 가격을 넣은 건수가 나옵니다. 아직 넣지 않은 건수는 그 아래 버튼이 말합니다. 보스 수익에서 보던 주를 그대로 이어받아 열립니다.',
        },
      ],
    },
    {
