...
describe('v4 축 파생', () => {
  ...
  // 288 은 4난이도 칩 한 줄이 안 접히는 하한이고 전 기기에서 폭이 같다는 성질도 갖는다.
