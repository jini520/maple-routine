...
//
// 이 저장소가 [[ADR-131]] sticky 가드·[[ADR-092]] 디버그 도구 가드에서 쓴 방식과 같다:
...
// 아니다** — 모달은 자기 판의 머리이고 온보딩 단계에는 헤더 줄 자체가 없다([[ADR-139]] 범위표의
...
describe('[[ADR-145]] 정정 1 — 제목 줄은 프리미티브 하나로 그린다', () => {
