 ...
 * 콘텐츠 여백이라 축이 다르다([[ADR-139]] 결정 2, 정정 1 에서도 그대로 유지).
 *
 * 그 인셋을 실제로 읽는 자리는 [[ADR-144]] 정정 2 로 **단계 셸**(`app/onboarding/OnboardingStep.tsx`)
...
describe('[[ADR-139]] 정정 1 — 상단 안전영역은 한 자리에서 나온다', () => {
  it('검사 대상을 실제로 찾는다', () => {
