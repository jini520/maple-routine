...
// 검사할 방법이 없었다.** 여기서 지켜야 할 것들 — 8프레임 시점에 아이템이 뜬다([[ADR-103]] 결정 3) ·
...
/** 단계별 고정 fps — [[ADR-038]] 방식, 값은 [[ADR-103]] 이 1.5배로 상향한 것. */
export const DROP_EFFECT_FPS = { screen: 22.5, pre: 21, loop: 17.25, end: 18 } as const

/**
 * 아이템 등장 트리거 — **시간이 아니라 ScreenEff 프레임 인덱스**다([[ADR-103]] 결정 3).
