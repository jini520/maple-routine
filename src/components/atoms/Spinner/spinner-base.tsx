/**
 * 스피너 둘이 함께 쓰는 프롭과 반복 모션([[ADR-199]] 정정 2).
 *
 * 잎 격자와 뿌리 배선은 `atoms/Icon` 의 `SvgFrame` 이 갖는다. 여기 있는 것은 **움직임 쪽**이다 —
 * 그것이 스피너를 아이콘과 가르는 유일한 축이다.
 */
...
/** 스피너 둘의 프롭. 색은 `className` 이 정하고 크기는 폭만 준다(높이는 잎 격자가 낸다). */
