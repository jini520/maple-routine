 ...
 *
 * 그렇게 가른 이유는 두 플랫폼의 네임스페이스 방식이 애초에 다르기 때문이다
 * (`docs/migration/data.md` 결정 1, 원본은 `@capacitor/preferences` 의 `Preferences.java`·`Preferences.swift`):
 *
