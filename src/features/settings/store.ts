 ...
 *
 * 원래 이 스토어의 본체는 «계정(메이플 ID) 변경» 플로우였다([[ADR-086]] 결정 6 — 키 재조회 ·
 * 계정 선택 · 예열 · 캐릭터 재선택 커밋). 그 기능은 [[ADR-143]] 결정 7 이 폐지했고(계정을 바꾸는
 * 일이 「캐릭터 관리」의 드롭다운 안으로 들어갔다), 화면들이 지워진 뒤로도 남아 있던 액션 넷
