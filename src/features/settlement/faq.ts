/**
 * 결산 안내 줄이 여는 FAQ. **문구는 사용자가 확정한 것**이라 임의로 손대지 말 것.
 *
 * `00:00 ~ 02:00` 은 서버 로그 여섯 밤의 실측이고 **설명이지 판정이 아니다.** 앱은 이 시각으로
...
export const SETTLEMENT_FAQ: readonly FaqItem[] = [
  {
    ...
    answer: [
      {
        kind: 'paragraph',
        text: '넥슨이 일간, 주간 스케줄러 기록을 모아 확정하는 작업입니다. 00:00 ~ 02:00 사이에 진행되며, 결산 중에는 일부 기록이 조회되지 않습니다.',
      },
    ],
  },
  {
