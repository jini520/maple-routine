 ...
 */
export async function fetchAndRecordCharacterList(credential: NexonCredential, now: Date = new Date()): Promise<MapleAccount[]> {
  const accounts = await fetchCharacterList(credential, worldKeyOfApiName)
