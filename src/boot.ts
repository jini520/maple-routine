...
import { rnHapticsPort } from './native/adapters/rn-haptics'
 ...
 *
 * 열다섯째가 `HapticsPort` 다(`rn-haptics.ts`). 두드림 하나뿐이고, 그 하나를 두 플랫폼이
 * 서로 다른 API 로 낸다.
 *
 * 그 목록을 먼저 떠난 것이 셋이다:
