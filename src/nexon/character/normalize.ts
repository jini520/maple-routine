...
// 캐릭터가 0명인 메이플 ID는 여기서 걸러진다. `MapleAccount` 의 뜻이 "응답에 있던 계정"이
...
// "가입한 길드 없음"(null·빈 문자열)과 "모름"(필드 자체가 응답에 없음)을 갈라둔다.
...
// character_exp_rate는 숫자가 아니라 문자열("80.300")로 온다. 여기서 풀어두지 않으면
