...
const BOSS_PORTRAIT_CROPS = cropsData as Record<string, ImageCrop>
...
// UI 표시 파라미터라 값은 AI가 임의로 채우지 않고 사용자가 직접 조정한다(ADR-006과 동일한 원칙).
const BOSS_PORTRAIT_ICON_CROPS = iconCropsData as Record<string, ImageCrop>
