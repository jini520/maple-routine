...
**공유 조각 아홉(step 6)에 이어 화면을 옮겼다**(4단계 step 7, 2026-08-13 —
`packages/app-rn/src/app/boss-profit/`). 드롭 화면 셋은 step 8 몫이다. RN 에서 갈린 것과
**육안 대조 목록**은 [README «4-6단계 결과»·«4-7단계 결과»](./README.md) 에 있다.
