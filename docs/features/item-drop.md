...
> **관련 ADR**: [[ADR-011]] [[ADR-010]] [[ADR-038]] [[ADR-039]] [[ADR-040]] [[ADR-041]] [[ADR-045]] [[ADR-048]] [[ADR-069]] [[ADR-070]] [[ADR-071]] [[ADR-103]] [[ADR-124]] [[ADR-146]]. **관련 문서**: [../foundation/game-data.md](../foundation/game-data.md), [boss-profit.md](./boss-profit.md), [today.md](./today.md).
...
- **요약은 기간이 길어질수록 점점 슬퍼진다 — 시드는 단풍잎**([[ADR-071]] 결정 9, 사용자 확정 2026-08-01). 첫 구현의 카드는 반려됐고(유일하게 남은 배경 요소) 시안 11종 비교 끝에 브랜드 마크가 시드는 안을 택했다 — 단풍잎은 원래 색을 잃고 기울다 떨어지므로 억지 장식이 아니다.
  ...
  - **문구는 사용자 지정**(2026-08-01, 구현자가 톤을 다듬지 않는다). "N주차" = **미획득 N-1주**(1주차 = 먹은 그 주). **단계마다 «풀»이다**([[ADR-146]] 정정 6·10 — 처음엔 0~3주가 한 줄 고정이고 마지막 단계만 풀이었다). `0주: 와따리! ㅇㄱㄱㄷ`·`완전 럭키비키잖아`·`폼 미쳤다` / `1주: 그래, 그럴 수 있지`·`다음 주엔 되겠지` / `2주: 어?! 슬슬 쫌 그래!?`·`슬슬 킹받는데`·`이게 맞나?` / `3주: 선넘네?!`·`이게 억까지 뭐야` / `4주+: 이건 아니지...`·`적당히 해!` + 같은 톤 3개. **기존 열한 줄은 각 풀의 첫 항목**이라 인덱스 0 이 예전과 같은 문구를 준다(더한 것이지 갈아 치운 것이 아니다).
