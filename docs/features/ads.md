...
| 스토어 게시 후 AdMob 연결 + 검토 | ⏳ **iOS 진행 가능**(App Store 게시 2026-08-06) — AdMob 콘솔에서 앱을 스토어 등록정보에 연결하고 검토(2~3일)를 통과해야 정상 노출된다. 그 전까지는 *"limited ad serving"* 이라 **광고가 안 뜨는 것이 버그가 아니다** |
