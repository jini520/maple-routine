...
import { DEFAULT_DARK_THEME, DEFAULT_THEME, getThemeDefinition } from '@core/lib/theme-registry'
import type { ThemeName } from '@core/types'
import { getTheme, setTheme } from '@core/storage/theme'
import { getColorSchemePort, getThemeAppearancePort } from '@core/native/ports'
...
// 묻는 법이 달라(웹뷰는 미디어 쿼리, RN 은 Appearance) 포트가 답한다([[ADR-127]]).
 ...
 * [[ADR-099]] · [[ADR-122]]). 그 DOM 작업은 `ThemeAppearancePort` 구현이 갖는다.
 *
