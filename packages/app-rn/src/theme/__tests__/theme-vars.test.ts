// 테마 값이 **이름과 값 그대로** 변수 맵에 실리는지 지킨다([[ADR-127]] 3단계).
//
...
import { buildThemeCss, THEME_NAMES, getThemeDefinition } from '@core/lib/theme-registry'
import { THEME_TOKEN_KEYS } from '@core/lib/theme-derive'
