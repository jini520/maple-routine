 ...
 * 읽힌다).
 *
 * ## 시계를 읽는 유일한 위젯이다 ([[ADR-146]] 정정 39, 사용자 지시)
 *
 ...
 * 번을 못 세도 다음 렌더가 맞는 값을 준다. `atMs` 는 [[ADR-146]] 구현 노트가 «지금 아무 위젯도 안
 ...
 *
 * **초를 그리는 곳에서는 안 쓴다**([[ADR-146]] 정정 39) — `43초` 가 그 말을 직접 한다.
 */
      ...
      <View className="flex-row items-baseline">
        ...
        <View className="ml-auto">
          <Value
            ...
            // **일일만 초까지**([[ADR-146]] 정정 39) — 수십 시간 남은 값에 초를 붙이면 글자만 길어지고
            // 아무도 안 본다.
