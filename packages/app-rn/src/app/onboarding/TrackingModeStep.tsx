// 스케줄 관리 방법(자동/수동) 선택 — 온보딩 넷째 단계([[ADR-035]] 결정 13·16·17·22 · [[ADR-060]]).
//
// 카드 박스 없이 배경 위에 바로 놓이는 페이지 레이아웃(`ApiKeyForm`·`AccountSelectionList` 와 동일)을
// 따르고, 바깥 선택 카드 클래스는 `AccountSelectionList` 와 계속 공유한다 — 결정 22 가 푼 것은 카드
...
//    (`DifficultySegment`·`CharacterTrackingGrid` 와 같은 판단) — 전달되는 사실은 같다.
