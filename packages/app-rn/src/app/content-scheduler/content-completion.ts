...
export function dailyContentProgress(contents: DailyContent[]): ContentProgress {
  return tally(contents.map(dailyContentCompletion))
}

export function weeklyContentProgress(contents: WeeklyContent[]): ContentProgress {
  return tally(contents.map(weeklyContentCompletion))
}
