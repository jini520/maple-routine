// **웹에는 이 화면의 테스트가 없다** — 명세로 삼을 것이 파일 주석과 [[ADR-120]] 결정 11 뿐이다.
...
describe('SettingsPrivacyScreen', () => {
  ...
  // [[ADR-120]] 결정 11: **사본을 두지 않는다** — 같은 사이트를 싣기만 한다. 그래서 이 화면이
  ...
  // [[ADR-062]] 결정 3: 실패의 원인을 **실제로 푸는 행동**을 준다 — 여기서 안 되는 것을 되는
